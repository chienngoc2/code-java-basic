...
//  Constructor
    ...
    public static Object objMenu(Object... options) {
        ...
        return null; // Trả về null nếu không có lựa chọn
        }
        int choice;
        do {
   ...
   public static int getInt(String prompt, int min, int max) {
    ...
    public static String getEmail() {
        String mail = getString("Enter the Email");

        while (!Acceptable.isValid(mail, Acceptable.EMAIL_VAlID)) {
            
            mail = getString("Wrong account or password, please check again: ");
        }
        return mail;

    }
    public static String getNumPhone() {
        String num = getString("Enter phone number: ");

        while ( !Acceptable.isValid(num,Acceptable.VIETTEL_VALID) && 
            ...
            num = getString("Please check phone number again:");
        }
        return num;
    ...
    public static double  getTuitionCal(String phone) {
        double  tuition = 6000000.00;
